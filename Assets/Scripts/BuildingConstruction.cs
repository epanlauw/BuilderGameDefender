...
public class BuildingConstruction : MonoBehaviour
{
    ...
    {
        Transform pfBuildingConstruction = Resources.Load<Transform>("Prefabs/Buildings/pfBuildingConstruction");
    ...
    private void Awake()
    {
        ...
        Instantiate(Resources.Load<Transform>("Particles/pfBuildingPlacedParticles"), transform.position, Quaternion.identity);
    }
